    <a href="https://wa.me/6282237787222?" target="_blank" class="position-fixed"
      style="bottom: 20px; right: 20px; z-index: 1030;">
      <img src={{ asset('images/beranda/whatsapp.png') }} alt="WhatsApp"
        style="width: 60px; height: 60px;" class="rounded-circle shadow">
    </a>
